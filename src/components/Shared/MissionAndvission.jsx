        ...
        <div className="mb-10">
          ...
          <ul className="list-disc list-inside space-y-4">
            <li className="text-xl">
              ...
              />
              <strong className="text-yellow-200">Expand financial literacy:</strong> We bridge the digital
              divide by providing accessible education on cryptocurrency and its
            ...
            <li className="text-[19px]">
              <FontAwesomeIcon
                ...
                className="mr-2 text-yellow-500"
              />
              <strong className="text-yellow-200">Combat health disparities:</strong> We address the
              disproportionate impact of illnesses like sickle cell disease on
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-4">
            ...
            <li  className="text-[19px]">
              ...
              access to quality healthcare, advancements in treatment for sickle
              cell disease, and the exploration of holistic approaches to
              wellness.
            </li>
          </ul>
