...
const AboutUsHome = () => {
  return (
    <section className="bg-gradient-to-r from-[#ff9900]  to-[#f04928] h-full 
    w-[100vw] relative py-20 overflow-hidden">
      ...
      <div className="py-5 px-10 md:px-[10%] bg-[rgba(0,0,0,0.3)] mx-[6%] rounded-[20px] text-left z-0 ">
        <p className="text-xl sm:text-2xl font-semibold text-white my-10 tracking-widest">
          Karanja Gaçuça is an activist with Occupy Wall Street. Born in Kenya,
          Gaçuça attended Middlesex University in the UK and then moved to the
          United States. While in the U.S. Gaçuça worked on Wall Street and
          blogged about progressive issues. in the UK and then moved to the
          United States. While in the U.S. Gaçuça worked on Wall Street and
          blogged about progressive issues.
        </p>
        <p className="text-xl sm:text-2xl font-semibold text-white my-10 tracking-widest">
      ...
      <div className="mx-10 md:mx-[30%] my-24">
        <h4 className="text-xl md:text-3xl font-extrabold text-white tracking-widest  ">BANTER TOKEN</h4>
        <input type="text" className="bg-white h-14 w-full my-5 rounded-[30px]" />
      </div>
    </section>
  );
};
